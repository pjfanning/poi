...
import org.apache.poi.ooxml.extractor.ExtractorException;
import org.apache.poi.ooxml.extractor.ExtractorSAXUtils;
import org.apache.poi.ooxml.extractor.ParseContext;
...
public class XWPFStylesShim {
    ...
    public XWPFStylesShim(PackagePart part, ParseContext parseContext)
            throws IOException, ExtractorException, SAXException {
    ...
    private class StylesStripper extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String qName, Attributes atts)
                throws SAXException {
            if (uri == null || NS_WORDPROCESSINGML.equals(uri)) {
                if ("style".equals(localName)) {
                    currentStyleId =
                            atts.getValue(NS_WORDPROCESSINGML, "styleId");
                } else if ("name".equals(localName)) {
                    String name = atts.getValue(NS_WORDPROCESSINGML, "val");
